...
// const nutribulit = (mango, jagode) => {
//   const komadiciManga = secko(mango);
//   const komadiciJagoda = secko(jagode);
//   const sok = `Dobili ste sok od ${komadiciManga} komadica manga i ${komadiciJagoda} komadica jagoda.`;
//   console.log(sok);
//   return sok;
// };
// nutribulit(4, 6);
...
// const penzija = (birthYear, myName) => {
//   const trenutnaGodina = 2023 - birthYear;
//   const uslovPenzije = 65 - trenutnaGodina;
//   console.log(
//     `${myName} vi imate ${trenutnaGodina} godina i potrbno Vam je ${uslovPenzije} godine do penzije.`
//   );
//   return uslovPenzije;
// };
// penzija(2001, 'Haris');
...
// TASK 2
const avgDolphins = calcAverage(144, 123, 171);
...
const checkWinner = (avgDolphins, avgKoalas) => {
  if (avgDolphins >= 2 * avgKoalas) {
    console.log(
      `Delfini su pobedili jer je njihov rezultat ${avgDolphins} veci od rezultata koji imaju kolae a njihov rezultat je ${avgKoalas}.`
    );
  } else if (avgKoalas >= 2 * avgDolphins) {
    console.log(
      `Koale su pobedili jer je njihov rezultat ${avgKoalas} veci od rezultata koji imaju delfini a njihov rezultat je ${avgDolphins}.`
    );
  } else {
    console.log(`Niko nije pobedio jer niko nema dvostruko veci rezultat!`);
  }
};
