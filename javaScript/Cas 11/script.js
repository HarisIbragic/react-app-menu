...
const userHari = {
  ...
  job: 'programer',
  age: 2023 - 2001,
  address: 'Emina Redzepagica 26',
  student: true,
  friends: ['Deni', 'Aske', 'Keno'],
};
console.log(userHari);

userHari[friends.push('Mesa')];
console.log(friends);
const InforamtionofHaris = prompt(
  'Sta zelite da saznate o Harisu? Izaberite: firstName, lastName, age, address,  job, student, instagram ili friends'
);

if (userHari[InforamtionofHaris]) {
  console.log(userHari[InforamtionofHaris]);
} else {
  console.log('Error!!! NISTE UNELI TACNO!');
}
userHari.instagram = 'ibragic.h';
console.log(userHari.instagram);

console.log(userHari.friends[2]);
console.log(userHari['friends'][userHari['friends'].lenght - 1]);
